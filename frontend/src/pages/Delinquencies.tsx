    ...
    <Box>
      <StandardReport
        ...
        columns={[
          ...
          { field: 'fresh_slippage',     label: 'Fresh Slippage', fmt: 'num' },
          { field: 'od030_prev_count',   label: '0-30 Prev',      fmt: 'num' },
          { field: 'od030_regularized',  label: 'Regularized',    fmt: 'num' },
          { field: 'od030_not_paid',     label: 'Not Paid',       fmt: 'num' },
          { field: 'members_no_pay',     label: 'No Pay',         fmt: 'num' },
        ]}
      />
    </Box>
  )
